...
target 'QuickAppTests' do
  pod 'SwiftyJSON', :git => 'https://github.com/jeneumeier/SwiftyJSON', :branch => 'swift3-gm' # Swift 3: False
  pod 'Quick'
  pod 'Nimble', '~> 4.0.0'
end
...
target 'QuickApp' do
    ...
    pod 'SwiftyJSON', :git => 'https://github.com/jeneumeier/SwiftyJSON', :branch => 'swift3-gm' # Swift 3: True
